...
class ProductionListController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('production.production_list.index', compact('dplPaginator', 'displayGroups'));
    }

    public function create()
    {
        return view('production.production_list.create', $this->buildFormData(new DailyProductionList(), false));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('production-list.index')->with('success', 'Production List created successfully.');
    }

    public function show($id)
    {
        $dpl = $this->findDpl((int) $id);
        return view('production.production_list.view', $this->buildFormData($dpl, true));
    }

    public function edit($id)
    {
        $dpl = $this->findDpl((int) $id);
        return view('production.production_list.edit', $this->buildFormData($dpl, false));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('production-list.index')->with('success', 'Production List updated successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('production-list.index')->with('success', 'Production List deleted successfully.');
    }
